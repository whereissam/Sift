...
class RealtimeTranscriptionSession:
    ...
    def __init__(
        ...
        Args:
            ...
            polisher: Optional TranscriptPolisher (app.knowledge). Injected
                rather than constructed so this layer stays free of any
        ...
        # LLM polisher — supplied by the caller (see class docstring).
        self.polisher = polisher if enable_llm_polish else None
